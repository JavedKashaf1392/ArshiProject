...
<span class="divider">|</span>  
  ...
  <button type="submit" class="search-button">
   ...
   <img src="${images}/Phone1.jpg"  width="25" height="25" alt=""/>
                    ...
                    <a href="ProductByFruits" onclick="location.href=this.href+'?param='+val;return false;">Fruits Vegetables</a>
                    <a href="ProductByFruits" onclick="location.href=this.href+'?param='+val2;return false;">Leafy Vegetables</a>
                    <a href="ProductByFruits" onclick="location.href=this.href+'?param='+val3;return false;">Milk</a>
                   <%--  <a href="${pageContext.request.contextPath }/ProductByFruits" id="target" data-custom-value="Milk">Leafy Vegetables</a>
                    <a href="${pageContext.request.contextPath }/ProductByFruits" data-value="Milk" id="click">Milk</a> --%>
                    <a href="#">Discount</a>
                    <a href="#">Blog</a>
                    <a href="#">Contact Us</a>
    
   <script> 
        var val = "Fruit Vegetables"; 
        var val2 = "Leafy Vegetables"; 
        var val3= "Milk"; 
    </script> 
...
$("#click").click(function(event){console.log($(this).data("value"));});`
   ...
   <%--<form style="margin-top:15px;" id="form-id" action="${pageContext.request.contextPath }/ProductByFruits">
   <input type="hidden" name="param" value="${menu.paramKey}"/> 
   <a id="target" onclick="document.getElementById('form-id').submit();" data-custom-value="${menu.paramKey}">${menu.menues}</a> 
   </form>  --%>
   <%--</c:forEach>--%>
    
   
   <%-- <a href="${pageContext.request.contextPath }/ProductByFruits/Fruit Vegetables">Fruit Vegetables</a>
   <a href="#" onclick="document.getElementById('form-id').submit();" onforminput="Fruits Vegetables" >Leafy Vegetables</a>
   <a href="#" data-custom-value="Fruit Vegetables">MIlk</a>
   <a href="#">Discount</a>
   <a href="#">Blog</a>
   <a href="#">Contact Us</a> --%>                         
                          
   <%-- <a href="${pageContext.request.contextPath }/ProductByFruit">Fruit Vegetables</a>
   <a href="${pageContext.request.contextPath }/ProductByLeafy">Leafy Vegetables</a>
   <a href="${pageContext.request.contextPath }/ProductBymilk">Milk</a>
   <a href="#">Discount</a>
   <a href="#">Blog</a>
   <a href="#">Contact Us</a>  --%>
