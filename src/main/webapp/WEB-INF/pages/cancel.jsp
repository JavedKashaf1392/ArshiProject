...
<span style="border:1 px green;background-color:white;font-weight: bold;color: green;font-size:25px;font-weight:500px;">Cancel Order</span>
</div>
...
<div class="wrapper">
	   ...
	   <strong>Dear ${customerModel.firstName}</strong>
	   <p>Your order has been canceled. The items listed below were part of the canceled</p>
       </div>
...
Maharastra 345678
  ...
  <div class="product">
   ...
   <img src="${images}/${orderitem.product.imageName}"  alt="tomato" width="100" height="100"/>
    </div>
    <div class="product-details">
      <div class="product-title">${orderitem.product.productName}</div>
      <p class="product-description">The best dog bones of all time. Holy crap. Your dog will be begging for these things! I got curious once and ate one myself. I'm a fan.</p>
    </div>
    <div class="product-price">&#8377;<fmt:formatNumber type="number" minFractionDigits="2" maxFractionDigits="2" value="${orderitem.product.price}"/></div>
    <div class="product-quantity">
    <p class="product-description">${orderitem.productQuantity}</p>
     <!--  <input type="text" value="2" min="1"> -->
    </div>
    <div class="product-line-price">&#8377;<fmt:formatNumber type="number" minFractionDigits="2" maxFractionDigits="2" value="${orderitem.totalAmount}"/></div>
  ...
  <div class="totals">
    <div class="totals-item">
      ...
      <div class="totals-value" id="cart-subtotal"> &#8377;<fmt:formatNumber type="number" minFractionDigits="2" maxFractionDigits="2" value="${order.orderTotal}" /></div>
    </div>
   
    <div class="totals-item totals-item-total">
      <label>Grand Total</label>
      <div class="totals-value" id="cart-total"> &#8377;<fmt:formatNumber type="number" minFractionDigits="2" maxFractionDigits="2" value="${order.totalBillAmount}" /></div>
    </div>
    </div>
...
<b style="font-size: 14px;">Note:</b>If you have any questions about your order, please contact  us toll free at (+91) 982 357 6042 .For Refund Money <a href="#" id="myBtn">click here</a>
...
<div id="myModal" class="modal">
  ...
  <div class="modal-content">
   ...
   <h1
			...
			<div style="text-align: center;">
				<a href="${pageContext.request.contextPath}/wallet/addRefudMoneyInWallet/${order.orderid}"
					style="display: inline-block; padding: 10px 30px; text-align: center; text-decoration: none; color: black; background-color: white; border-radius: 6px; outline: none; margin-top: 6px; font-size: 15px; border: 1px solid green;">Yes</a>
				<a href="#"
					style="display: inline-block; padding: 10px 30px; text-align: center; text-decoration: none; color: #ffffff; background-color: #4CAF50; border-radius: 6px; outline: none; margin-top: 6px; font-size: 15px; border: 1px solid green;">No</a>
