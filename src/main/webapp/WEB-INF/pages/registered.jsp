...
<body>
  ...
  margin: 0 auto; ">
	...
	<form id="myStudentForm" class="form">
...
<!-- ..........City........... -->
 ...
 <select  id="location" name="location">
  ...
  <i class="fas fa-check-circle"></i>
	...
	<div class="form-control">
			<!-- <label for="username">Username</label> -->
			<input type="text" placeholder="Password" id="txtNewPassword" name="password"/>
			<i class="fas fa-check-circle"></i>
			<i class="fas fa-exclamation-circle"></i>
	...
	<div class="form-control">
			<!-- <label for="username">Username</label> -->
			<input type="text" placeholder="Confirm Password" name="confirmPassword" id="txtConfirmPassword"/>
			<i class="fas fa-check-circle"></i>
			<i class="fas fa-exclamation-circle"></i>
            <span id="txtConfirmPasswordError"></span>
			<!-- <small>Error message</small> -->
		</div>
...
<!-- ............Script Code.......... -->
        ...
        $(document).ready(function () {
           ...
           var txtConfirmPasswordError = false;
            ...
            function validate_firstName() {
                ...
                if (val == '') {
                    $("#firstNameError").html("Enter <b>First Name</b>");
                    $("#firstNameError").css("color", "red");
                    $("#firstNameError").show();
                    firstNameError = false;
                } else if (!exp.test(val)) {
                    $("#firstNameError").html("Enter <b>Valid First Name</b>");
                    $("#firstNameError").css("color", "red");
                    $("#firstNameError").show();
                    firstNameError = false;
                } else {
            ...
            function validate_lastName() {
                ...
                if (val == '') {
                    $("#lastNameError").html("Enter <b>last Name</b>");
                    $("#lastNameError").css("color", "red");
                    $("#lastNameError").show();
                    lastNameError = false;
                } else if (!exp.test(val)) {
                    $("#lastNameError").html("Enter <b>Valid Name</b>");
                    $("#lastNameError").css("color", "red");
                    $("#lastNameError").show();
                    lastNameError = false;
                } else {
            ...
            function validate_mobile() {
                ...
                var exp = /^[1-9][0-9]*$/;
                if (val == '') {
                    $("#mobileError").html("Enter <b>Mobile Number</b>");
                    $("#mobileError").css("color", "red");
                    $("#mobileError").show();
                    mobileError = false;
                } 
                else if (val.length!=10){
                	 $("#mobileError").html(" Mobile Number must be 10 digits only");
                     $("#mobileError").css("color", "red");
                     $("#mobileError").show();
                     mobileError = false;
                    }
                    ...
                    $("#mobileError").html("Enter <b>Valid Mobile Number</b>");
                    $("#mobileError").css("color", "red");
                    $("#mobileError").show();
                    mobileError = false;
                } else {
            ...
            function validate_email(){
        		...
        		if(val==''){
        			...
        			$("#emailError").html("Enter <b>Valid Mail</b>");
        			$("#emailError").css("color","red");
        			$("#emailError").show();
        			emailError = false;
        		} 
 ...
 //----------location-----------//
            ...
            function validate_location() {
                ...
                if (val == '') {
                    $("#locationError").html("Select <b>Location</b>");
 ...
 /* ...............Passowrd........... */
            ...
            function validate_txtNewPassword(){
        		...
        		if(val==''){
        			...
        			$("#passwordError").html("Enter <b>Passwords lenght must be between 6 and 8</b>");
        			$("#passwordError").css("color","red");
        			$("#passwordError").show();
        			passwordError = false;
            		}
            ...
            /* ...............ConfirmPassowrd........... */
                       ...
                       function validate_txtConfirmPassword(){
                   		...
                   		//var exp = /^[A-Za-z0-9\.\-]+\@[a-z]+\.[a-z\.]{2,10}$/;
                   		if(val==''){
                   			$("#txtConfirmPasswordError").html("Enter <b>Confirm Password</b>");
                   			$("#txtConfirmPasswordError").css("color","red");
                   			$("#txtConfirmPasswordError").show();
                   			txtConfirmPasswordError = false;
                   		}
                   		else if(value !== val) {
                   			$("#txtConfirmPasswordError").html("Enter <b>Passwords Does Not Match</b>");
                   			$("#txtConfirmPasswordError").css("color","red");
                   			$("#txtConfirmPasswordError").show();
                   			txtConfirmPasswordError = false;
                       		}
            ...
            $("#myStudentForm").submit(function () {
                ...
                if (firstNameError && lastNameError && mobileError  && emailError && cityError && passwordError && txtConfirmPasswordError)
                    return true;
                else
                    return false;
            });
