		...
		<footer class="footer-distributed">
			...
			<div class="footer-right" style="text-align:left;">
				<p class="footer-company-about">
					...
					and Identify The True Taste of Nutritions . . . . . .  <button  onclick="window.location.href='${pageContext.request.contextPath}/VFAbout'" class="readmorebutton">Read More</button></p>
