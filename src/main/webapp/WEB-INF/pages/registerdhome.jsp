...
<div class="container">
		...
		<ul>
            ...
            <h6 style="color: black;"> Size:${product.size} g<h6>
					...
					<div class="product-price-wrap"
						...
						<div class="left">
							<span class="price" style="margin-left: 10px; margin-top: 4%;">
								<span class="mrp"
								style="font-size: 14px; color: black; font-weight: 300; position: relative; color: black;">MRP</span>

								<span class="old-price">&#8377 ${product.price}</span> &#8377
								${product.price-product.discount * product.price/100}
							</span>

							<button id="b" type="button"
								onclick="window.location.href='${pageContext.request.contextPath }/cart/addToCartPageItem/${product.productid}'"
								style="background-color: #4CAF50; border: 0; color: #ffffff; font-size: 14px; font-weight: 600; padding: 10px 30px; border-radius: 3px; margin-left: 18%; margin-top: 12%;">
   ...
   <input class="button button1" type="submit" value="Search" formaction="${pageContext.request.contextPath}/product/searchProduct" />
			...
			<div style="margin-top: 5px; align-content: center; margin-left: 27%">
				<input type="submit"
					style="width: 200px; cursor: pointer; margin: 5px 5px; font-size: 16px; text-decoration: none; border-radius: 8px; text-align: center; color: white; background-color: #4CAF50; padding: 11px; border: none;"
					value="Add"
	...
	<div class="main-content">
		<div class="left box">
			...
			<div class="content">
				...
				<br> <a href="#" style="color: white">Terms And Condition</a><br>
				<br>
				<!--  <a href="#"  style="color:white">Carriers</a><br><br> -->
				<!-- <a href="#"  style="color:white">Affiliate</a><br><br> -->
				<a href="#" style="color: white">In News</a><br>
				<br>
			...
			<div class="bottom">
				<center>
					<span class="credit">Created By <a
						href="https://youtube.com/c/codingnepal">veggiefridge</a> |
