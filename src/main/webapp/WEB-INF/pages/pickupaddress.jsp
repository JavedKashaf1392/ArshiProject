...
<div class="row">
      ...
      <form action="/action_page.php">
        ...
        <div class="row">
          ...
          <div class="col-50">
            ...
            <label for="cname">Enter contact number</label>
            <input type="text" id="cname" name="cardname" placeholder="0081627506">
            <label for="ccnum">Order Id</label>
            <input type="text" id="ccnum" name="cardnumber" placeholder="1111-2222-3333-4444">
            <label for="expmonth">Cart Id</label>
            <input type="text" id="expmonth" name="expmonth" placeholder="1111">
            <label for="expmonth">Transaction Id</label>
            <input type="text" id="expmonth" name="expmonth" placeholder="0000">
           <!--  <div class="row">
              <div class="col-50">
  ...
  <div class="col-25">
    <div class="container">
      ...
      <hr>
      <p>Total <span class="price" style="color:black"><b>Rs30</b></span></p>
    </div>
  </div>
</div>
