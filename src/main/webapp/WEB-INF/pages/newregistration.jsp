...
<body>
    <div align="center">
    <div><h2><p style="color:green;">New Customer</p></h2></div>
       <!--  <h2>New/Edit Product</h2> -->
        <form:form action="${pageContext.request.contextPath}/login/saveCustomer" method="post" modelAttribute="customer">
        <table>
