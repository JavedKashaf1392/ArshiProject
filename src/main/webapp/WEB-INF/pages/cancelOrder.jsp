...
<a href="${pageContext.request.contextPath}/order/pendingorders" style="display: inline-block;
 ...
 <a href="${pageContext.request.contextPath}/order/deliveredorder" style="display: inline-block;
        ...
        outline: none;margin-top:6px">Delivered</a>
			...
			<table id="myTable"
				style="margin-left: auto; margin-right: auto; text-align: center; border-collapse: collapse; width: 100%; border: 1px solid #ddd; font-size: 18px; align-content: center; background-color: white; margin-bottom: 50px;">
				...
				<c:forEach var="orders" items="${CancelOrders}">
					<tr style="border-bottom: 1px solid #ddd;">
						<td style="text-align: center; padding: 16px;"><a
							href="${pageContext.request.contextPath }/order/listOrderItem/${orders.orderid}"
