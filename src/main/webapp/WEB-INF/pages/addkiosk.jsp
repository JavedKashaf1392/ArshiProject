...
input[type=text],select, textarea {
  ...
  box-sizing: border-box;
   ...
   <body>
   <form method="post" action="${pageContext.request.contextPath}/kiosk/saveKiosk" modelAttribute="kiosk"> 
            ...
            <tr>
                ...
                <td>
                    <select id="locationid" name="state">
                        ...
                        <c:forEach items="${listkiosklocation}" var="kiosklocation">
                            <option   value="${kiosklocation.state}">${kiosklocation.state}</option>
                        </c:forEach>
                    </select>
                </td>
            </tr>  
