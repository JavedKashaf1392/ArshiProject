...
public class PaytmDetails {
		...
		public PaytmDetails() {
			System.out.println("PaytmDetails.PaytmDetails()");
		}

		@Override
		public String toString() {
			return "PaytmDetails [merchantId=" + merchantId + ", merchantKey=" + merchantKey + ", channelId="
					+ channelId + ", website=" + website + ", industryTypeId=" + industryTypeId + ", paytmUrl="
					+ paytmUrl + ", details=" + details + "]";
		}
